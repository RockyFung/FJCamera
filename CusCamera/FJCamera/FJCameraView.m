...
@interface FJCameraView()<UIGestureRecognizerDelegate>
...
- (void)configCamera{
    ...
    if (interfaceOrientation == UIInterfaceOrientationLandscapeLeft){
         self.previewLayer.connection.videoOrientation = UIInterfaceOrientationLandscapeLeft;
    } else {
...
- (FJCaptureFlashMode)getCaptureFlashMode {
    return (FJCaptureFlashMode)self.device.torchMode;
}
